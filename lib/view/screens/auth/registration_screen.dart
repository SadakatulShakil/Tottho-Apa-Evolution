...
import 'package:sixvalley_vendor_app/data/model/response/upazila_model.dart';
import 'package:sixvalley_vendor_app/helper/email_checker.dart';
import 'package:sixvalley_vendor_app/localization/language_constrants.dart';
import 'package:sixvalley_vendor_app/provider/auth_provider.dart';
import 'package:sixvalley_vendor_app/provider/district_provider.dart';
import 'package:sixvalley_vendor_app/provider/upazila_provider.dart';
    ...
    _tabController?.addListener((){
      switch (_tabController!.index){
        case 0:
          ...
          break;
        case 1:
          Provider.of<UpazilaProvider>(context, listen: false);
                        ...
                        child: CustomButton(
                          ...
                          // }
                            ...
                            RegisterModel registerModel =  RegisterModel(
                                ...
                                district: authProvider.districtId,
                                upazila: authProvider.upazilaId
                            );
